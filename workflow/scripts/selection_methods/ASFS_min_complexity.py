# for this method, only a ipynb was available --> copied here
...
def SVM_active_feature_selection(X_train, y_train, X_test, y_test, num_features, num_samples, balance=False):
    ...
    def scores(i):
        ...
        return model.score(X_global[:, i].reshape(-1, 1),
                           y_global)  # R^2 for regression and mean accuracy for classificarion
